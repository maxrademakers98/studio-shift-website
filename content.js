...
const CONTENT = {
  ...
  team1_bio:  "Roel is a sustainability professional with experience across B2B and B2C sectors, working in international value chains to drive measurable environmental and social impact. Experience includes:<br><b>•⁠  ⁠G-Star RAW – Textiles & fashion<br>•⁠  ⁠HEMA – Consumer goods<br>•⁠  ⁠DSG – Construction materials<br></b>He specialises in developing and implementing ESG strategies, including sustainability data exchange across supply chains to enable better decision-making in products and production. His work spans social compliance and human rights, environmental sustainability, GHG footprinting, B Corp certification and stakeholder engagement.",
  ...
  // ── FREELANCERS PAGE ──────────────────────────────
  fl_hero_badge:          "Freelance with Studio SHIFT",
  fl_hero_h1:             "Join a team that<br>does <em>real</em> work.",
  fl_hero_sub:            "We're always looking for sustainability specialists to join our pool of collaborators. Hands-on expertise, meaningful projects, fair rates.",
  ...
  s3_headline1:    "Your biggest opportunity",
  s3_headline2:    "starts with your products.",
  s3_center_pct:   "85%",
  s3_center_sub1:  "OF TOTAL EMISSIONS",
  s3_center_sub2:  "IS SCOPE 3",
  s3_body1:        "Most companies only act on Scopes 1 & 2.",
  s3_body2:        "The real change is in the other 85%.",
  s3_legend1:      "SCOPE 3 — 85%",
  s3_legend2:      "SCOPE 2 — 10%",
  s3_legend3:      "SCOPE 1 — 5%",

};

// ─── Injector — do not edit below this line ────────
(function injectContent() {
  ...
  // Chip arrays (with optional sub-group labels)
  document.querySelectorAll('[data-chips]').forEach(el => {
    const chips = CONTENT[el.getAttribute('data-chips')];
    if (!chips) return;
    el.innerHTML = chips.map(item =>
      typeof item === 'object' && item.sub
        ? `<span class="step-chip-sub">${item.sub}</span>`
        : `<div class="step-chip">${item.chip || item}</div>`
    ).join('');
  });
